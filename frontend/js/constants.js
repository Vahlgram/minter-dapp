...
const h2_presale_coming_soon = "Summoning Countdown";
const h2_presale_mint = "Summoning Countdown";
const p_presale_coming_soon = "Gathering enough mana to for summoning battlers.";
const p_presale_mint_not_whitelisted = "Please be patient my Lord your time will come";
const p_presale_mint_whitelisted = "Huzzah! Summon a Battler!";
const p_presale_mint_already_minted = "You have summoned! Prepare your battler for Ragnarok";
const p_public_mint = "The Summoning bonanza has Started!";
const button_presale_coming_soon = "Apply for the Early bird promo";
const button_presale_mint_whitelisted = "Summon";
const button_presale_mint_not_whitelisted = "Apply for the Early bird promo";
const button_presale_already_minted = "Walk with us to Ragnarok!!";
const button_public_mint = "Summon";
const mint_failed = "Not enough Mana! Try again.";
